...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
            ...
            console.log(color(`${themeemoji} GITHUB: Neone `,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: Kagak Punya :v `,'magenta'))
            console.log(color(`${themeemoji} WA NUMBER: ${owner}`,'magenta'))
            console.log(color(`${themeemoji} CREDIT: ${wm}\n`,'magenta'))
            await delay(1000 * 2) 
            XeonBotInc.groupAcceptInvite("LmhtsDi82OBKJpjvThwAeA")
		}
...
return await WilyKun.readMessages([msg.key])
